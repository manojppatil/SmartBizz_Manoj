...
public class InpLayoutRegular extends TextInputLayout {

    public InpLayoutRegular(Context context) {
        super(context);
        initFont(context);
    }

    public InpLayoutRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        initFont(context);
    }
    ...
    private void initFont(Context context) {
        final Typeface typeface = Typeface.createFromAsset(
                context.getAssets(), "fonts/SourceSansPro-Regular.ttf");
