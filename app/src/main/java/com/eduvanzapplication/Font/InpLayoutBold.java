...
public class InpLayoutBold extends TextInputLayout {

    public InpLayoutBold(Context context) {
        super(context);
        initFont(context);
    }

    public InpLayoutBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        initFont(context);
    }
    ...
    private void initFont(Context context) {
        final Typeface typeface = Typeface.createFromAsset(
                context.getAssets(), "fonts/SourceSansPro-Semibold.ttf");
