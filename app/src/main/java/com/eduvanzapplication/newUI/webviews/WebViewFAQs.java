...
public class WebViewFAQs extends AppCompatActivity {

    private WebView webView;
    public String fileName = "faq.htm";
    Toolbar toolbar;
...
//        typefaceFont = Typeface.createFromAsset(context.getAssets(), "fonts/droidsans_font.ttf" );
            ...
            Globle.ErrorLog(WebViewFAQs.this,className, name, errorMsg, errorMsgDetails, errorLine);
        }
