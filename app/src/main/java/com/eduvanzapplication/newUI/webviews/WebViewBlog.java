...
public class WebViewBlog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            getSupportActionBar().setTitle(R.string.title_blog);
            ...
            webView.loadUrl("file:///android_asset/blogs.html");
        } catch (Exception e) {
            ...
            Globle.ErrorLog(WebViewBlog.this,className, name, errorMsg, errorMsgDetails, errorLine);
        }
