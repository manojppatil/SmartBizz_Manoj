...
public class AmortAdapter1 extends RecyclerView.Adapter<AmortAdapter1.ViewHolder>{
    ...
    public AmortAdapter1(List<MLoanEmis> list, Context context, FragmentActivity activity ){
        this.list = list;
    ...
    @NonNull
    @Override
    public AmortAdapter1.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
        View view = inflater.inflate(R.layout.amortlist_card_view1,viewGroup, false);
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            linPayBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Log.d(AmortAdapter1.class.getSimpleName(),"LEADID -"+itemView.getTag().toString());
