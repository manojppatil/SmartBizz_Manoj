...
//public class GetMobileNoAutoRead extends AppCompatActivity {
//
//    private final String TAG = GetMobileNoAutoRead.class.getSimpleName();
...
//                ActivityCompat.requestPermissions(GetMobileNoAutoRead.this,
//                        new String[]{
...
//        progressDialog = new ProgressDialog(GetMobileNoAutoRead.this);
...
//                    params.put("otp", "1234");
//                    if (!Globle.isNetworkAvailable(GetMobileNoAutoRead.this)) {
//                        Snackbar.make(linGetOtp, getString(R.string.please_check_your_network_connection), Snackbar.LENGTH_SHORT).show();
//                    } else {
//                        VolleyCall volleyCall = new VolleyCall();
//                        volleyCall.sendRequest(getApplicationContext(), url, GetMobileNoAutoRead.this, null, "otpLogin", params, MainActivity.auth_token);
//                    }
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
...
//            } else {
//                VolleyCall volleyCall = new VolleyCall();
//                volleyCall.sendRequest(getApplicationContext(), url, GetMobileNoAutoRead.this, null, "verifyOtpCode", params, MainActivity.auth_token);
//            }
//        } catch (Exception e) {
...
//            Globle.ErrorLog(GetMobileNoAutoRead.this, className, name, errorMsg, errorMsgDetails, errorLine);
//        }
//
//    }
//
...
//            } else {
//                VolleyCall volleyCall = new VolleyCall();
//                volleyCall.sendRequest(getApplicationContext(), url, GetMobileNoAutoRead.this, null, "getOtp", params, MainActivity.auth_token);
//            }
//        } catch (Exception e) {
//            progressDialog.dismiss();
//            String className = this.getClass().getSimpleName();
...
//
//                startActivity(new Intent(GetMobileNoAutoRead.this, DashboardActivity.class)
...
//                Toast.makeText(GetMobileNoAutoRead.this, message, Toast.LENGTH_SHORT).show();
//            }
//
//        } catch (Exception e) {
//            progressDialog.dismiss();
...
//            } else {
//                VolleyCall volleyCall = new VolleyCall();
//                volleyCall.sendRequest(getApplicationContext(), url, GetMobileNoAutoRead.this, null, "generateOtpCode", params, MainActivity.auth_token);
//                signUpCalled = true;
//            }
//        } catch (Exception e) {
//            progressDialog.dismiss();
