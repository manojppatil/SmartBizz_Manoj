...
public class FinancialAnalysis extends AppCompatActivity {
    ...
    private final String TAG = FinancialAnalysis.class.getSimpleName();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (permission != PackageManager.PERMISSION_GRANTED) {//Direct Permission without disclaimer dialog
                ActivityCompat.requestPermissions(FinancialAnalysis.this,
    ...
    private void setViews() {
        progressDialog = new ProgressDialog(FinancialAnalysis.this);
...
// profile. ID and basic profile are included in DEFAULT_SIGN_IN.
    ...
    private void verifyOtpCode() {
        try {
            ...
            if (!Globle.isNetworkAvailable(FinancialAnalysis.this)) {
                Snackbar.make(linGetOtp, getString(R.string.please_check_your_network_connection), Snackbar.LENGTH_SHORT).show();
            } else {
                VolleyCall volleyCall = new VolleyCall();
                volleyCall.sendRequest(getApplicationContext(), url, FinancialAnalysis.this, null, "verifyOtpCode", params, MainActivity.auth_token);
            }
        } catch (Exception e) {
            ...
            Globle.ErrorLog(FinancialAnalysis.this, className, name, errorMsg, errorMsgDetails, errorLine);
        }
    ...
    public void getOtp() {
        try {
            ...
            if (!Globle.isNetworkAvailable(FinancialAnalysis.this)) {
                ...
                VolleyCall volleyCall = new VolleyCall();
                volleyCall.sendRequest(getApplicationContext(), url, FinancialAnalysis.this, null, "getOtp", params, MainActivity.auth_token);
            }
        } catch (Exception e) {
            progressDialog.dismiss();
            String className = this.getClass().getSimpleName();
    ...
    public void otpLogin() {
        try {
            ...
            if (!Globle.isNetworkAvailable(FinancialAnalysis.this)) {
                ...
                VolleyCall volleyCall = new VolleyCall();
                volleyCall.sendRequest(getApplicationContext(), url, FinancialAnalysis.this, null, "otpLogin", params, MainActivity.auth_token);
            }
        } catch (Exception e) {
            progressDialog.dismiss();
            String className = this.getClass().getSimpleName();
    ...
    public void otpLoginResponse(JSONObject jsonData) {
        try {
            ...
            if (status.equalsIgnoreCase("1")) {
                ...
                startActivity(new Intent(FinancialAnalysis.this, DashboardActivity.class)
                ...
                Toast.makeText(FinancialAnalysis.this, message, Toast.LENGTH_SHORT).show();
            }
    ...
    public void generateOtpCode() {
        try {
            ...
            if (!Globle.isNetworkAvailable(FinancialAnalysis.this)) {
                ...
                VolleyCall volleyCall = new VolleyCall();
                volleyCall.sendRequest(getApplicationContext(), url, FinancialAnalysis.this, null, "generateOtpCode", params, MainActivity.auth_token);
                signUpCalled = true;
            }
        } catch (Exception e) {
            progressDialog.dismiss();
